...
class ConfigProvider(object):
    _properties = {
        ...
        "DRM_PLAYREADY_LAURL":
            BitmovinArgument("server url for playready"),
        "DRM_WIDEVINE_KID":
    ...
    def get_is_dash(self):
        return self._get_or_throw_exception("IS_DASH")
    ...
    def get_drm_playready_laurl(self):
        return self._get_or_throw_exception("DRM_PLAYREADY_LAURL")
